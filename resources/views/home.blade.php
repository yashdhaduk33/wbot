            ...
            <div class="card-body d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center gap-2">
                        <span class="fw-bold fs-4">{{ $stats['active_bots'] ?? 0 }}</span>
                        @if(!empty($stats['trend_bots']))<span class="text-success small">{{ $stats['trend_bots'] }}</span>@endif
                    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center gap-2">
                        <span class="fw-bold fs-4">{{ $stats['messages_sent'] ?? '0' }}</span>
                        @if(!empty($stats['trend_messages']))<span class="text-success small">{{ $stats['trend_messages'] }}</span>@endif
                    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center gap-2">
                        <span class="fw-bold fs-4">{{ $stats['connected_users'] ?? 0 }}</span>
                        @if(!empty($stats['trend_users']))<span class="text-success small">{{ $stats['trend_users'] }}</span>@endif
                    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center gap-2">
                        <span class="fw-bold fs-4">{{ $stats['uptime'] ?? '99.9%' }}</span>
                        @if(!empty($stats['trend_uptime']))<span class="text-success small">{{ $stats['trend_uptime'] }}</span>@endif
                    </div>
